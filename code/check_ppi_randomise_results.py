...
def main() -> int:
    ...
    readme.write_text(
        ...
        "sidecars and small stage-2 beta TSVs for portable plotting. The analysis "
        "uses the original 10 Smith09 maps, z-scored run-level timecourses, and "
        "component 11 for the DMN x ECN interaction.\n"
    )
