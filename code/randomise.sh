...
case "$contrast" in
    both-minus-sham|both-minus-rtpj|both-minus-vlpfc|rtpj-minus-vlpfc|rtpj-minus-sham|vlpfc-minus-sham|both-minus-mean-rtpj-vlpfc|mean-stimulation-minus-sham) ;;
